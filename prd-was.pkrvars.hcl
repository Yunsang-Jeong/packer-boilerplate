...
########################################
# Ansible
ansible_playbook = "./ansible-playbook/playbook-was.yaml"
ansible_role_path = "./ansible-role/"
ansible_parameters = {
    EFS_REIOGN                  = "ap-northeast-2"
    EFS_ID                      = "fs-xxxxxxxx"
    EFS_MOUNTED_DIRECTORY       = "/data"
    EFS_MOUNTED_DIRECTORY_OWNER = "waswas"
}
########################################